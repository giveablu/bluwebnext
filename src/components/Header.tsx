      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <Link 
              href="/donate"
              className="btn-with-icon px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#e74c3c] hover:bg-[#c0392b] transition-colors duration-200"
            >
              <svg 
                className="ct-icon" 
                fill="currentColor" 
          ...
          <div className="md:hidden">
            <button
              ...
              className="ct-header-trigger inline-flex items-center justify-center p-2 rounded-md text-[#1a1a1a] hover:text-[#e74c3c] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#e74c3c] transition-colors duration-200"
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
              ...
              <div className="pt-4">
                <Link 
                  href="/donate"
                  className="btn-with-icon w-full justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#e74c3c] hover:bg-[#c0392b] transition-colors duration-200"
                >
                  <svg 
                    className="ct-icon" 
                    fill="currentColor" 
