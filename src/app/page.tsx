    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#e74c3c] to-[#c0392b] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/donate"
              className="btn-with-icon px-8 py-3 border border-transparent text-lg font-medium rounded-md text-[#e74c3c] bg-white hover:bg-gray-100 transition-colors duration-200"
            >
              <svg 
                className="ct-icon" 
                fill="currentColor" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="ct-icon-container inline-flex items-center justify-center w-16 h-16 bg-[#e74c3c] rounded-full mb-6">
                <svg 
                  className="ct-icon icon-large" 
                  fill="currentColor" 
                  viewBox="0 0 20 20"
                >
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link 
            href="/donate"
            className="btn-with-icon px-8 py-3 border border-transparent text-lg font-medium rounded-md text-white bg-[#e74c3c] hover:bg-[#c0392b] transition-colors duration-200"
          >
            <svg 
              className="ct-icon" 
              fill="currentColor" 
